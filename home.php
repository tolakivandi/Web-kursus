  ...
  <section class="dark:bg-white-200 dark:text-gray-100">
    <div class="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
      ...
      <div class="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
        <h1 class="text-5xl font-bold leading-none text-black sm:text-5xl">Welcome<span class="dark:text-green-900"> Course_
            <br>
          </span>Class
        </h1>
        <p class="mt-6 mb-8 text-lg font-bold text-gray-900 sm:mb-12">Selamat datang di website course class! Kami senang Anda telah berkunjung ke sini.
