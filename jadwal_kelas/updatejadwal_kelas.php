...
$id = $_GET['id'];
$jadwal = query("SELECT * FROM jadwal_kelas WHERE id_jadwal = $id")[0];
    ...
    <div class="flex items-center justify-center w-full h-screen overflow-hidden rounded-lg">
        <div class="w-1/3 md:flex">
            <div class="w-full px-6 py-8 md:p-8">
                <h2 class="mb-2 text-2xl font-bold text-black">Tambah Mapel</h2>
                <form action="" method="POST">
                    ...
                    <div class="mb-4">
                        <label class="block mb-2 font-bold text-black" for="mapel">
                            hari
                        </label>
                        <input class="w-full px-3 py-2 leading-tight text-black border rounded-lg appearance-none focus:outline-none focus:shadow-outline" id="hari" name="hari" type="text" placeholder="Masukkan Nama Mapel" value="<?= $jadwal['hari']; ?> ">
                    </div>
                    <div class="mb-4">
                        <label class="block mb-2 font-bold text-black" for="jam_mulai">
                            jam mulai
                        </label>
                        <input class="w-full px-3 py-2 leading-tight text-black border rounded-lg appearance-none focus:outline-none focus:shadow-outline" id="jam_mulai" name="jam_mulai" type="text" placeholder="jam mulai" value="<?= $jadwal['jam_mulai']; ?> ">
                    </div>
                    <div class="mb-4">
                        <label class="block mb-2 font-bold text-black" for="jam_selesai">
                            jam selesai
                        </label>
                        <input class="w-full px-3 py-2 leading-tight text-black border rounded-lg appearance-none focus:outline-none focus:shadow-outline" id="jam_selesai" name="jam_selesai" type="text" placeholder="jam selesai" value="<?= $jadwal['jam_selesai']; ?> ">
                    </div>

                    <div class="flex items-center justify-between">
                        <button class="px-4 py-2 font-bold text-white bg-green-800 border-2 rounded-lg hover:bg-black focus:outline-none focus:shadow-outline" type="submit" name="submit">
                            Daftar
                        </button>
                    </div>
                </form>
