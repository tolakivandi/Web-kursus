 ...
 <body class="bg-transparent ">
     <nav class="w-full py-4 text-white bg-green-600 mb-10">
     ...
     <h1 class="px-6 py-5 font-bold text-center text-black text-xl">Tambah Jadwal</h1>

     <form method="post" action="" class="w-1/4 mx-auto ">


         <div>
             <label class="font-semibold text-black mb-2 " for="nama_peserta">Nama_peserta :</label>
             <input class="w-full px-3 py-2 mb-2 text-black bg-white rounded-lg border-2" type="text" name="nama_peserta" id="nama_peserta">
         </div>
         <div>
             <label class="font-semibold text-black mb-2" for="alamat_peserta">Alamat_peserta :</label>
             <input class="w-full px-3 py-2 mb-2 text-black bg-white rounded-lg border-2" type="text" name="alamat_peserta" id="alamat_peserta">
         </div>
         <div>
             <label class="font-semibold text-black mb-2" for="no_tlep_peserta">No_tlep_peserta :</label>
             <input class="w-full px-3 py-2 mb-2 text-black bg-white rounded-lg border-2" type="text" name="no_tlep_peserta" id="no_tlep_peserta">
         </div>

         <div>
             <label class="font-semibold text-black mb-2" for="email_peserta">Email_peserta :</label>
             <input class="w-full px-3 py-2 mb-2 text-black bg-white rounded-lg border-2" type="text" name="email_peserta" id="email_peserta">
         </div>
         <br>
         <button class="px-3 py-2 font-semibold text-white rounded-lg bg-green-700 border-2" type="submit" name="submit" id="submit">tambah data</button>
     </form>
