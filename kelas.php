 ...
 <head>
     ...
     <title>KelasTambah Jadwal</title>
...
-moz-box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);">
             <thead class="text-white">
                 <tr>
                     ...
                     <th class="py-3 bg-green-800">KELAS</th>
             ...
             <tbody class="text-center text-cyan-900">
                 <tr class="duration-300 cursor-pointer bg-green-300">
                     ...
                     <td class="flex justify-center gap-5 px-6 py-3">
                         <a href="./kelas/updatekelas.php?id=<?= $mhs["id_kelas"]; ?> " class="px-4 py-3 font-semibold text-black border-2 border-black bg-green-700 rounded-xl">Update</a> |
                         <a href="./kelas/deletekelas.php?id=<?= $mhs["id_kelas"]; ?> " onclick="return confirm('yakin?');" class="px-4 py-3 font-semibold text-black border-2 border-black bg-green-700 rounded-xl">Delete</a>
                     </td>
                 </tr>
                 <?php $i++; ?>
             <?php endforeach; ?>
         ...
         <button type="text" class=" bg-green-800 hover:bg-indigo-400 focus:bg-indigo-400 text-white font-semibold rounded-lg px-4 py-3 mt-6 ml-[583px] border-2 " style="box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);
-webkit-box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);
