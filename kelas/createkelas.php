 ...
 <body>
     ...
     <div class="flex items-center justify-center w-full h-screen overflow-hidden bg-white rounded-lg">
         <div class="w-1/3 md:flex">
             <div class="w-full px-6 py-8 md:p-8 mb-6">
                 <h2 class=" text-2xl font-bold text-gray-700 mb-6">Tambah Kelas</h2>

                 <form action="" method="POST">
                     <div class="mb-4">
                         <label class="block mb-2 font-bold text-gray-700" for="nama_kelas">
                             Kelas
                         </label>
                         <input class="w-full px-3 py-2 leading-tight text-gray-700 border rounded-lg appearance-none focus:outline-none focus:shadow-outline" id="nama_kelas" name="nama_kelas" type="text" placeholder="Masukkan Nama Kelas">
                     </div>

                     <div class="flex items-center justify-between">
                         <button class="px-4 py-2 font-bold text-white bg-green-700 rounded-lg focus:outline-none focus:shadow-outline" type="submit" name="submit">
                             Daftar
                         </button>
                     </div>
                 </form>
