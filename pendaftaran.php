 ...
 <body class="bg-gradient-to-r from-green-200 to-green-400">
     ...
     <div class="flex flex-col items-center justify-center h-screen bg-green-800 ">
         <table class="shadow-2xl font-[Poppins] border-2 border-green-200 max-w-7xl/12" style="box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);
...
-moz-box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);">
             ...
             <tbody class="text-center text-green-900">
                 ...
                 <?php foreach ($mahasiswa as $mhs) : ?>
                     <tr class="duration-300 cursor-pointer bg-green-300">
                         ...
                         <td class="px-6 py-3 font-semibold"> <?= $mhs["nama_kelas"]; ?> </td>
                         <td class="px-6 py-3 font-semibold"> <?= $mhs["nama_peserta"]; ?> </td>
                         <td class="px-6 py-3 font-semibold"> <?= $mhs["nama_pengajar"]; ?> </td>
                         <td class="px-6 py-3 font-semibold"> <?= $mhs["tanggal_daftar"]; ?> </td>
                         <td class="px-6 py-3 font-semibold"> <?= $mhs["status_pembayaran"]; ?> </td>
                         <td class="flex justify-center gap-5 px-6 py-3">
                             <a href="./pendaftaran/updatependaftaran.php?id=<?= $mhs["id_pendaftaran"]; ?> " class="px-4 py-3 font-semibold text-black border-2 border-black bg-green-700 rounded-xl">Update</a> |
                             <a href="./pendaftaran/deletependaftaran.php?id=<?= $mhs["id_pendaftaran"]; ?> " onclick="return confirm('yakin?');" class="px-4 py-3 font-semibold text-black border-2 border-black bg-green-700 rounded-xl">Delete</a>
                         </td>
                     </tr>
                     <?php $i++; ?>
                 <?php endforeach; ?>
         ...
         <button type="text" class=" bg-green-800 hover:bg-indigo-400 focus:bg-indigo-400 text-white font-semibold rounded-lg px-4 py-3 mt-6 ml-[780px] border-2 " style="box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);
-webkit-box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);
-moz-box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);"> <a href="./pendaftaran/creatependaftaran.php">Tambah Data</a> </button>
     </div>
 </body>
