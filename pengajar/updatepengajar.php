...
$id = $_GET['id'];
$pnjr = query("SELECT * FROM pengajar WHERE id_pengajar = $id")[0];
    ...
    <div class="flex items-center justify-center w-full h-screen overflow-hidden bg-white rounded-lg">
        <div class="w-1/3 md:flex">
            <div class="w-full px-6 py-8 md:p-8">
                <h2 class="text-2xl font-bold text-gray-700 mb-6 ">Tambah Kelas</h2>

                <form action="" method="POST">
                    <div class="mb-4">
                        <input type="hidden" name="id_pengajar" value="<?= $pnjr['id_pengajar']; ?>">
                        <label class="block mb-2 font-bold text-gray-700" for="nama_pengajar">
                            nama_pengajar
                        </label>
                        <input class="w-full px-3 py-2 leading-tight text-gray-700 border rounded-lg appearance-none focus:outline-none focus:shadow-outline" id="nama_pengajar" name="nama_pengajar" type="text" placeholder="Masukkan Nama Pengajar" value="<?= $pnjr['nama_pengajar']; ?>">
                        <label class="block mb-2 font-bold text-gray-700" for="alamat_pengajar">
                            alamat_pengajar
                        </label>
                        <input class="w-full px-3 py-2 leading-tight text-gray-700 border rounded-lg appearance-none focus:outline-none focus:shadow-outline" id="alamat_pengajar" name="alamat_pengajar" type="text" placeholder="Masukkan Alamat Pengajar" value="<?= $pnjr['alamat_pengajar']; ?>">
                        <label class="block mb-2 font-bold text-gray-700" for="no_telp_pengajar">
                            no_telp_pengajar
                        </label>
                        <input class="w-full px-3 py-2 leading-tight text-gray-700 border rounded-lg appearance-none focus:outline-none focus:shadow-outline" id="no_telp_pengajar" name="no_telp_pengajar" type="text" placeholder="Masukkan No Telepon Pengajar" value="<?= $pnjr['no_telp_pengajar']; ?>">
                        <label class="block mb-2 font-bold text-gray-700" for="email_pengajar">
                            email_pengajar
                        </label>
                        <input class="w-full px-3 py-2 leading-tight text-gray-700 border rounded-lg appearance-none focus:outline-none focus:shadow-outline" id="email_pengajar" name="email_pengajar" type="text" placeholder="Masukkan Email Pengajar" value="<?= $pnjr['email_pengajar']; ?>">
                    </div>
