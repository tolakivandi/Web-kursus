...
-moz-box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);">
       ...
       <tbody class="text-center text-green-900">
         <tr class="duration-300 cursor-pointer bg-green-300">
           ...
           <td class="px-6 py-3"> <?= $item["nama_peserta"]; ?> </td>
           <td class="px-6 py-3"> <?= $item["alamat_peserta"]; ?> </td>
           <td class="px-6 py-3"> <?= $item["no_tlep_peserta"]; ?> </td>
           <td class="px-6 py-3"> <?= $item["email_peserta"]; ?> </td>
         </tr>
         <?php $i++; ?>
       <?php endforeach; ?>
       </tbody>
