 <?php
    ...
    $id = $_GET['id'];
    $mhs = query("SELECT * FROM pendaftaran WHERE id_pendaftaran = $id")[0];
     ...
     <div class="flex items-center justify-center w-full h-screen overflow-hidden bg-white rounded-lg">
         <div class="w-1/3 md:flex">
             <div class="w-full px-6 py-8 md:p-8">
                 <h2 class="mb-2 text-2xl font-bold text-gray-700 py-10">Tambah Kelas</h2>
                 <form action="" method="POST">
                     <input type="hidden" name="id_pendaftaran" id="id_pendaftaran" value=" <?= $mhs['id_pendaftaran']; ?> ">
                     <div class="mb-4">
                         <label class="block mb-2 font-bold text-gray-700" for="tanggal_daftar">
                             tanggal_daftar
                         </label>
                         <input class="w-full px-3 py-2 leading-tight text-gray-700 border rounded-lg appearance-none focus:outline-none focus:shadow-outline" id="tanggal_daftar" name="tanggal_daftar" type="text" placeholder="Masukkan tanggal_daftar" value=" <?= $mhs['tanggal_daftar']; ?> ">
                     </div>
                     <div class="mb-4">
                         <label class="block mb-2 font-bold text-gray-700" for="status_pembayaran">
                             status_pembayaran
                         </label>
                         <input class="w-full px-3 py-2 leading-tight text-gray-700 border rounded-lg appearance-none focus:outline-none focus:shadow-outline" id="status_pembayaran" name="status_pembayaran" type="text" placeholder="Masukkan NO HP" value=" <?= $mhs['status_pembayaran']; ?> ">
                     </div>
